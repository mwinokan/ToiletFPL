...
def main():
	...
	for i,pid in enumerate(player_ids):
		...
		expected, actual = p.expected_total_points(return_actual=True,use_official=False)
	...
	fig = go.Figure()
	fig.add_trace(go.Scatter(x=xdata, y=ydata, text=tdata, textposition='middle right', mode='markers'))
